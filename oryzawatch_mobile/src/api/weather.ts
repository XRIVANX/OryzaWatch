...
export async function getCurrentWeather(municipality: string): Promise<CurrentWeather> {
  ...
  return {
    ...
    windDirection: toCompassDirection(current.wind_direction_10m),
    precipitation: current.precipitation,
    description: WEATHER_DESCRIPTIONS[current.weather_code] ?? 'Current conditions',
