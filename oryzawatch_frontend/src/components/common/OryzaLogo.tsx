...
export const OryzaLogo: React.FC<OryzaLogoProps> = ({
  ...
  const glowFilter = glow ? 'drop-shadow(0 0 12px rgba(74, 222, 128, 0.45))' : 'none';
  ...
  if (showText) {
    return (
      ...
      >
        {/* Circle Background */}
        <circle cx="100" cy="100" r="95" fill="#165233" stroke="rgba(74, 222, 128, 0.4)" strokeWidth="2" />
        ...
        {/* Text */}
        <text x="100" y="152" fontFamily="'Outfit', 'Inter', sans-serif" fontWeight="800" fontSize="16" fill="#ffffff" textAnchor="middle" letterSpacing="-0.02em">OryzaWatch</text>
        <text x="100" y="167" fontFamily="'Outfit', 'Inter', sans-serif" fontWeight="700" fontSize="6.5" fill="#facc15" textAnchor="middle" letterSpacing="0.08em">PREDICT. ALERT. PROTECT</text>
      </svg>
    );
  }
  ...
  return (
    <svg
      ...
      className={className}
    >
      <circle cx="50" cy="50" r="48" fill="#165233" stroke="rgba(74, 222, 128, 0.4)" strokeWidth="1.5" />
