...
const styles: Record<string, CSSProperties> = {
  ...
  uploadArea: {
    border: '2px dashed #444', borderRadius: '8px', padding: '20px',
    textAlign: 'center', backgroundColor: '#1a1a1a', cursor: 'pointer',
    position: 'relative', minHeight: '150px', display: 'flex',
    justifyContent: 'center', alignItems: 'center', transition: 'border-color 0.2s',
  },
  ...
  clearBtn: {
    padding: '6px 12px', backgroundColor: '#d32f2f', color: '#fff',
    border: 'none', borderRadius: '4px', fontSize: '12px', cursor: 'pointer', fontWeight: 'bold',
  },
};
